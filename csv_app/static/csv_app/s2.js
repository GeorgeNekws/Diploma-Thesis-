...
function getExtraInfo(){
  loadJSON("http://127.0.0.1:8000/csv_app/extra_data/?q_search="+forma.value(), gotExtraData);
}

function gotExtraData(extraData){
  globalExtraData = extraData;
  console.log(globalExtraData);
}
...
function setup() {
  ...
  background(220);
  loadJSON("http://127.0.0.1:8000/csv_app/my_data/?format=json", gotData);
}
